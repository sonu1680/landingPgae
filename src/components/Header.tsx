  ...
  return (
    <>
      ...
      <div className="w-full flex justify-center">
        <div className="bg-gradient-to-r from-[#ed2f0d] to-[#282b4e] text-white py-3 px-4 sm:py-4 sm:px-6 rounded-b-2xl max-w-[86rem] w-full">
          <div className="container mx-auto flex justify-start items-center text-xs sm:text-sm md:text-base lg:text-2xl gap-6 sm:gap-10 flex-wrap">
            <div className="flex items-center gap-2 sm:gap-3 ">
              <div className="p-2 rounded-sm border-2 border-white bg-cyan-300">

              <Phone className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6  " color="white" fill="white" />
              </div>
              <span className="font-bold" >+91 9374437099</span>
            </div>
            <div className="flex items-center gap-2 sm:gap-3">
            <div className="p-2 rounded-sm border-2 border-white bg-cyan-300">
              ...
              <span className="font-bold" >accruvia@gmail.com</span>
            </div>
          </div>
        </div>
      </div>
