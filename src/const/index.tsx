...
export const RECRUITMENT = [
  {
    ...
    moreData: {
      title: "EOR – Employee on Record",
      description: "Hiring in India should not be complicated and slow you down. With our EOR services, you can onboard talent in new markets—without setting up a legal entity. We handle the legal side so you can focus on the work.",
...

  {
    ...
    moreData: {
      title: "Permanent Hiring (FTE)",
      description: "Hiring full-time employees should not be a hassle. We keep it steady and smart. We help you find the right people for long-term roles—without delays or shortcuts. Our process works across industries and adjusts to what you need.",
...

  {
    ...
    moreData: {
      title: "Contract Staffing",
      description: "Sometimes you don’t need a full-time hire. You just need the right person for the job—right now. AccRuvia’s contract staffing lets you bring in skilled professionals on short-term contracts without long-term commitments. It’s a simple way to stay flexible, meet deadlines, and keep projects moving.",
...

  {
    ...
    moreData: {
      title: "Executive Search (CXOs)",
      description: "Hiring senior leaders does not mean just filling a role. It is about finding people who understand your description and share your values. They should know how to lead with purpose. We help you hire executives who fit your company and not just the job description.",
